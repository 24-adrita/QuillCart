...
public class CheckoutPanel extends JPanel {
    ...
    public CheckoutPanel(MainWindow frame) {
        ...
        JButton clearCartBtn = new JButton("Back");
    ...
    private void placeOrder() {
        ...
        // Hand over customer details so the purchase record can include the purchaser's info
        frame.setPendingCustomerInfo(fullName, phone, address);
