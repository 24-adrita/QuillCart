...
public class OwnerPanel extends JPanel {
    ...
    private static final Color BUTTON_COLOR = new Color(0x555555); // Formal dark gray
    private static final Color BUTTON_HOVER = new Color(0x777777);  // Lighter gray for hover

    public OwnerPanel(MainWindow frame) {
        this.frame = frame;
        setLayout(new BorderLayout(15, 15));
        setBackground(new Color(0x339999)); // Main panel background
        ...
        titleLabel.setBackground(new Color(0x004040)); // Owner Console header background
        ...
        JButton viewCustomers = new JButton("Customer Info Records");
        styleButton(viewCustomers);
        bottom.add(viewCustomers);
        ...
        viewCustomers.addActionListener(e -> frame.openCustomerRecords());
    }

    private void styleButton(JButton button) {
        button.setFont(new Font("Arial", Font.BOLD, FONT_SIZE + 2));
        button.setForeground(Color.WHITE); // formal text color
